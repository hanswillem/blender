...
class myScriptPanel(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        TheCol_01.operator("script.hello_world", text="Execute my script 01") #the operator class to execute and the text on the button
        #button 02
        TheCol_02 = self.layout.column(align=True)
        TheCol_02.operator("script.hello_world", text="Execute my script 02") #the operator class to execute and the text on the button
    #end draw
